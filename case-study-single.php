<?php include('header.php'); ?>
	...
	<div class="row middle-md row__threeFourths-height masthead margin--top" style="background: url('./images/mast.png'); background-size: cover; -webkit-background-size: cover; -moz-background-size: cover;">
	...
	<section>
		<div class="row center-xs middle-xs">
			<div class="col-xs-12 col-md-8 center-xs middle-xs statement">
				<h4 class="text--secondary">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</h4>
			</div>
		</div>
	</section>
	...
	<!-- Case Story Block 1 -->
	<div class="row row__threeFourths-height case--blue middle-xs">
		<div class="col-xs-12 col-md-6 no--padding">
			<img src="./images/mast_07.jpg">
		</div>
	...
	<!-- End Case Story Block 2 -->

	<!-- Case Story Block 3 -->
	<div class="row row__threeFourths-height case--teal middle-xs">
		<div class="col-xs-12 col-md-6 no--padding">
